...
This is an **ArcKit architecture governance project** — not a software codebase. It generates architecture documents (markdown) for the **International Trade AI Analytics Platform** at Department for Business and Trade.
...
Expected artifacts for project 001 (International Trade AI Analytics Platform):
...
The Department for Business and Trade (DBT) promotes British trade and investment worldwide, supports UK businesses, and negotiates free trade agreements. With trade data spanning hundreds of markets and thousands of product categories, AI can transform how DBT identifies export opportunities, assesses market risks, and supports UK businesses in international trade.

### Compliance Context

UK Government ministerial department. Applicable frameworks: GDS Service Standard, Technology Code of Practice (TCoP), NCSC Cyber Assessment Framework, ATRS for AI tools, UK GDPR, HM Treasury Green Book, AI Playbook.

### Key Stakeholders

DBT (policy owner), UK Export Finance, British Chambers of Commerce, Federation of Small Businesses, trade associations, FCDO (overseas posts), HMRC (customs data), Business Representative Organisations.
